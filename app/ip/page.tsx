  ...
  return (
    <section className="mt-2 flex flex-col items-center  md:flex-row md:justify-around lg:justify-evenly max-sm:ml-4  ">
      ...
      <div className="mt-5 flex flex-col gap-5 p-5 text-2xl items-center ">
        <div className="max-sm:max-w-[70vw] max-sm:mr-2">
          <Image
            src={logo}
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-5 ">
            <Link href="https://www.youtube.com/@idealeventsin">
              <h2 className="font-mont font-bold text-[1.5rem] max-sm:text-[1.2rem] max-sm:leading-5 ease-in-out duration-300 leading-10 hover:scale-110 whitespace-nowrap lg:text-[2.5rem] ">
                Be a part of our <br />
                Youtube family
              </h2>
              <hr className="w-full border border-[grey] mt-2 rounded-lg" />
            </Link>
            <Link href="https://www.youtube.com/@idealeventsin" className="">
              <Image
                src={youtube}
                alt="social media links"
                width={150}
                height={150}
                className="border border-[grey] rounded-[2.5rem] max-sm:rounded-[20px] max-sm:p-3 p-5 ease-in-out duration-100 hover:scale-105"
              />
            </Link>
          </div>
          <div className="flex items-center gap-5">
            <Link href="https://www.instagram.com/idealphotography.in/">
              <Image
                ...
                width={150}
                height={150}
                className="border border-black rounded-[2.5rem] max-sm:rounded-[20px] max-sm:p-3 p-5 ease-in-out duration-100 hover:scale-105"
              />
            </Link>
            <Link href="https://www.instagram.com/idealphotography.in/">
              <h2 className="font-mont font-bold text-[1.5rem] max-sm:text-[1.2rem] max-sm:leading-5 ease-in-out duration-300 leading-10 hover:scale-110 whitespace-nowrap text-right lg:text-[2.5rem]">
          ...
          <Link href="/ip" className="flex">
            <span className="text-xl font-bold text-[#381473] bg-[#C492C5]  p-2 flex gap-3 rounded-xl px-8 items-center ease-in-out duration-500 hover:bg-black hover:text-white ">
              ...
              <Image
                src={arrow}
                alt="arrow"
                className="ease-in duration-75  group-hover:ml-2 group-hover:scale-110 group-hover:text-white"
              />
            </span>
          </Link>
        </div>
